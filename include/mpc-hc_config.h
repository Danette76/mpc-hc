...
#define TRAC_URL     _T("http://trac.mpc-hc.org/")
#define BUGS_URL     _T("http://trac.mpc-hc.org/wiki/Bugs_-_Reporting")
#define TOOLBARS_URL _T("http://trac.mpc-hc.org/wiki/Toolbar_images")
